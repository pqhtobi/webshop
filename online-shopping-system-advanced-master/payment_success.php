								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>CẢM ƠN </h1>
											<hr/>
											<p>XIN CHÀO <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,SẢN PHẨM BẠN ĐẶT MUA ĐÃ THÀNH CÔNG MÃ THANH TOÁN LÀ <b><?php echo $trx_id; ?></b><br/>
											BẠN CÓ THỂ TIẾP TỤC TÌM KIẾM SẢN PHẨM <br/></p>
											<a href="index.php" class="btn btn-success btn-lg">QUAY LẠI TRANG CHỦ </a>
										</div>
