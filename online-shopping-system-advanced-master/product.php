                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 đánh giá(s) | sản phẩm đã xem</a>
							</div>
							<div>
								<h3 class="product-price">$'.$row['product_price'].'<del class="product-old-price">$990.00</del></h3>
								<span class="product-available">còn sản phẩm</span>
							</div>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Cây vợt cầu lông Victor chính hãng sẽ khá phù hợp với người có lực cổ tay trung bình, người chơi chuyên nghiệp, bán chuyên, trình độ khá trở lên. 
											Phù hợp cho người có lối chơi cân bằng, thích điều cầu, thích đập cầu bất ngờ cùng nhiều kỹ thuật bào mòn đói phương.</p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>- Độ cứng: Trung bình

- Khung vợt: High Resilience Modulus Graphite + HARD CORED TECHNOLOGY

- Thân vợt: High Resilience Modulus Graphite + 6.8 SHAFT
...
- Sức căng tối đa: 3U  ≦30 lbs(13.5Kg)
                             4U  ≦29 lbs(13Kg)</p>
										</div>
									</div>
								</div>
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											...
											<button class='quick-view'><i class='fa fa-eye'></i><span class='tooltipp'>đánh giá</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
